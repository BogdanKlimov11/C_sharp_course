...
<nav>
    <ol>
        ...
        <ul>
            ...
            <li><a href="#подраздел-3.2">Anchor</a></li>
            <ul>
                <li><a href="#подраздел-3.2.1">Anchor</a></li>
                <li><a href="#подраздел-3.2.2">Anchor</a></li>
            </ul>
            <li><a href="#подраздел-3.3">Anchor</a></li>
            <ul>
                <li><a href="#подраздел-3.3.1">Anchor</a></li>
                <li><a href="#подраздел-3.3.2">Anchor</a></li>
            </ul>
            <li><a href="#подраздел-3.4">Anchor</a></li>
            <ul>
                <li><a href="#подраздел-3.4.1">Anchor</a></li>
                <li><a href="#подраздел-3.4.2">Anchor</a></li>
            </ul>
        </ul>
        <li><a href="#раздел-4">Уровень 4: Эксперт (Expert)</a></li>
        <ul>
            <li><a href="#подраздел-4.1">Anchor</a></li>
            <ul>
                <li><a href="#подраздел-4.1.1">Anchor</a></li>
                <li><a href="#подраздел-4.1.2">Anchor</a></li>
            </ul>
            <li><a href="#подраздел-4.2">Anchor</a></li>
            <ul>
                <li><a href="#подраздел-4.2.1">Anchor</a></li>
                <li><a href="#подраздел-4.2.2">Anchor</a></li>
            </ul>
            <li><a href="#подраздел-4.3">Anchor</a></li>
            <ul>
                <li><a href="#подраздел-4.3.1">Anchor</a></li>
                <li><a href="#подраздел-4.3.2">Anchor</a></li>
            </ul>
            <li><a href="#подраздел-4.4">Anchor</a></li>
            <ul>
                <li><a href="#подраздел-4.4.1">Anchor</a></li>
                <li><a href="#подраздел-4.4.2">Anchor</a></li>
            </ul>
        </ul>
    </ol>
</nav>
...
<h2 id="раздел-1">Уровень 1: Начальный (Beginner)</h2>
    <p>. . .</p>
    <h3 id="подраздел-1.1">Section</h3>
        <p>. . .</p>
        <h4 id="подраздел-1.1.1">Section</h4>
            <p>. . .</p>
        <h4 id="подраздел-1.1.2">Section</h4>
            <p>. . .</p>
        <h4 id="подраздел-1.1.3">Section</h4>
            <p>. . .</p>
    <h3 id="подраздел-1.2">Section</h3>
        <p>. . .</p>
        <h4 id="подраздел-1.2.1">Section</h4>
            <p>. . .</p>
        <h4 id="подраздел-1.2.2">Section</h4>
            <p>. . .</p>
        <h4 id="подраздел-1.2.3">Section</h4>
            <p>. . .</p>
    <h3 id="подраздел-1.3">Section</h3>
        <p>. . .</p>
        <h4 id="подраздел-1.3.1">Section</h4>
            <p>. . .</p>
        <h4 id="подраздел-1.3.2">Section</h4>
            <p>. . .</p>
        <h4 id="подраздел-1.3.3">Section</h4>
            <p>. . .</p>
    <h3 id="подраздел-1.4">Section</h3>
        <p>. . .</p>
        <h4 id="подраздел-1.4.1">Section</h4>
            <p>. . .</p>
        <h4 id="подраздел-1.4.2">Section</h4>
            <p>. . .</p>
        <h4 id="подраздел-1.4.3">Section</h4>
            <p>. . .</p>
...
<p>. . .</p>
    <h3 id="подраздел-2.1">Section</h3>
        <p>. . .</p>
        <h4 id="подраздел-2.1.1">Section</h4>
            <p>. . .</p>
        <h4 id="подраздел-2.1.2">Section</h4>
            <p>. . .</p>
    <h3 id="подраздел-2.2">Section</h3>
        <p>. . .</p>
        <h4 id="подраздел-2.2.1">Section</h4>
            <p>. . .</p>
        <h4 id="подраздел-2.2.2">Section</h4>
            <p>. . .</p>
    <h3 id="подраздел-2.3">Section</h3>
        <p>. . .</p>
        <h4 id="подраздел-2.3.1">Section</h4>
            <p>. . .</p>
        <h4 id="подраздел-2.3.2">Section</h4>
            <p>. . .</p>
    <h3 id="подраздел-2.4">Section</h3>
        <p>. . .</p>
        <h4 id="подраздел-2.4.1">Section</h4>
            <p>. . .</p>
        <h4 id="подраздел-2.4.2">Section</h4>
            <p>. . .</p>
...
<p>. . .</p>
    <h3 id="подраздел-3.1">Section</h3>
        <p>. . .</p>
        <h4 id="подраздел-3.1.1">Section</h4>
            <p>. . .</p>
        <h4 id="подраздел-3.1.2">Section</h4>
            <p>. . .</p>
    <h3 id="подраздел-3.2">Section</h3>
        <p>. . .</p>
        <h4 id="подраздел-3.2.1">Section</h4>
            <p>. . .</p>
        <h4 id="подраздел-3.2.2">Section</h4>
            <p>. . .</p>
    <h3 id="подраздел-3.3">Section</h3>
        <p>. . .</p>
        <h4 id="подраздел-3.3.1">Section</h4>
            <p>. . .</p>
        <h4 id="подраздел-3.3.2">Section</h4>
            <p>. . .</p>
